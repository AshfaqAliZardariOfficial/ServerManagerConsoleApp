...
namespace ServerManagerConsoleApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string _base64EncodePublicExponent = JwsConvert.ToBase64String(_publicExponent);
            string _base64EncodePublicModulus = JwsConvert.ToBase64String(_publicModulus);
            ...
            string _protectedBase64Encode = JwsConvert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(_jws));
            ...
            string _payloadBase64Encode = JwsConvert.ToBase64String(System.Text.ASCIIEncoding.ASCII.GetBytes(strPayload));
            ...
            string _signatureBase64Encode = JwsConvert.ToBase64String(signedData);
